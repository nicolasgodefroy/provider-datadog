...
// WorkloadSecurityAgentRule is the Schema for the WorkloadSecurityAgentRules API. Provides a Datadog Cloud Workload Security Agent Rule API resource for agent rules. Deprecated, use datadogcsmthreatsagentrules resource instead: https://registry.io/providers/DataDog/datadog/latest/docs/resources/csmthreatsagent_rule
